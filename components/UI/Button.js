...
const Submit = (props) => {
  return (
    <Fragment>
      ...
      <h1 className="px-0.5 text-center text-[6px] sm:text-xs">
        OR
      </h1>
      <hr className="border w-1/12"></hr>
      </div>
      <div className="grid grid-cols-2 m-1">
        <button className="flex m-0.5 justify-end">
          <div className="flex border justify-center items-center rounded-sm text-[6px] sm:text-xs">
        ...
        <button className="flex m-0.5">
          <div className="flex justify-center items-center border rounded-sm text-[6px] sm:text-xs">
            <img
              className="w-2 h-2 sm:w-4 sm:h-3 mr-0.5"
              src="facebook1.png"
              alt="Facebook Logo"
            />
