    ...
    <div className="flex flex-col justify-center items-center sm:flex-grow p-2 max-w-md">
      ...
      <form className="border border-gray-300 rounded-lg mt-1 w-9/12">
        ...
        <div className="grid grid-cols-2 my-4 mx-4">
            ...
            <button
          type="submit"
          className=" bg-[#583D88] text-white text-[5px] uppercase mx-2 py-1 px-3 sm:py-2 sm:mx-3 sm:px-5 sm:text-[7px] font-bold rounded-3xl hover:bg-violet-700 focus:outline-none focus:shadow-outline"
        >
          Create an account
        </button>
        </div>
